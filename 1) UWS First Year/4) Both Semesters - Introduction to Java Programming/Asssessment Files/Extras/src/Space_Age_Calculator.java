...
public class Space_Age_Calculator {
	
	public static int earthAge;
	public static double earthYear = 365.25;
	public static double mercuryOrbit = 0.2408467;
	...
	// One orbit of Mercury = 0.2408467 of one Earth Year.
	// That's ~25%, so for one Earth Year, Mercury orbits ~4 times.
	// However many rotations of (planet) == one Earth Year
	// 1/(planet rotation) x EarthAge
				
	public static double Mercury() {
		double mercuryAge = (1/mercuryOrbit) * earthAge;
