...
public class CountDivisors {
	...
	public static void main(String[] args) {
		int N;	// A positive integer entered by the user. Divisors of this number will be counted.
		...
		int numberTested; 	// Used to count how many possible divisors of N have been tested. 
		// When the number reaches 1000000, a period is output and the value of number tested is reset to zero.
		...
		// Display the result.
		TextIO.putln("The number of divisors of " + N + " is " + divisorCount);
	} // end main()
