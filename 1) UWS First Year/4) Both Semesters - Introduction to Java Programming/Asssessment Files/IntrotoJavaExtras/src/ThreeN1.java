/**  
* This program prints out a 3N+1 sequence starting from a positive integer specified by the user.
* It also counts the number of terms in the sequence and prints out that number.
*/
 public class ThreeN1 {
      ...
      public static void main(String[] args) {                
        ...
        TextIO.put("\nThere were " + counter + " terms in the sequence.");
     }  // end of main()
