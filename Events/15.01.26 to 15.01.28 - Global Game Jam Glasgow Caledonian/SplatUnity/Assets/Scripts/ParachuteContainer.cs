...
public class ParachuteContainer : MonoBehaviour {
    ...
    public void EquipParachute(GameObject parachute, Parachute parachuteScript)
    {
        ...
        parachute.GetComponent<Rigidbody2D>().isKinematic = true;
        parachute.GetComponent<Collider2D>().enabled = false;
    ...
    public void UnEquipParachute()
    {
        ...
        parachute.GetComponent<Collider2D>().enabled = true;
        parachute.GetComponent<Rigidbody2D>().isKinematic = false;
