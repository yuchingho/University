...
public class Picture {
	 ...
	 * 
	 * @param source
	 *            the image source. If the source starts with http://, it is a
	...
	/*
	 * Scales this picture to a new size. If the new size is smaller than the
	 * old size, the remainder is filled with transparent pixels. If it is
	 * larger, it is clipped.
	 * 
	 * @param newWidth
	 *            the new width of the picture
	 * @param newHeight
