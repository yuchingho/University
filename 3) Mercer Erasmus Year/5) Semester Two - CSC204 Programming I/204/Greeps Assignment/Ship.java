...
public class Ship extends Actor {
    private int totalPassengers = 1000;     // Total number of passengers in this ship
    ...
    /** Possibly: Let one of the passengers out. Passengers appear at intervals, so this may or may not release the passenger. */
