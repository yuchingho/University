...
function create() {
	...
	//populate mushrooms
     theMushroom = game.add.group();
     theMushroom.enableBody = true;
     theMushroom.physicsBodyType = Phaser.Physics.ARCADE;

     for (var i = 0; i < 50; i++)
     {
         var c = theMushroom.create(game.world.randomX, Math.random() * 500, 'mushroom', game.rnd.integerInRange(0, 36));
...
function update() {
    ...
    game.physics.arcade.collide(bot, theMushroom, collisionHandlerScoring, null, this);
...
function collisionHandlerScoring (obj1, obj2) {

    game.stage.backgroundColor = '#992d2d';
	console.log("collisionHandlerScoring");
	obj2.kill();
}
